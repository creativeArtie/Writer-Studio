...
abstract class CheatsheetPaneView extends GridPane{
    ...
    CheatsheetPaneView(){
        ...
        CommonLayoutUtility.setWidthPrecent(this, 11); /// fills to: 26
        ...
        CommonLayoutUtility.setWidthPrecent(this, 6); /// fills to: 32
        ...
        CommonLayoutUtility.setWidthPrecent(this, 6); /// fills to: 38
        ...
        CommonLayoutUtility.setWidthPrecent(this, 12); /// fills to: 50
        ...
        CommonLayoutUtility.setWidthPrecent(this, 12); /// fills to: 62
        ...
        CommonLayoutUtility.setWidthPrecent(this, 12); /// fills to: 74

        addLabel(hintLabels, getLabel(HintText.FORMAT_REF_KEY), 8, 0);
        CommonLayoutUtility.setWidthPrecent(this, 12); /// fills to: 86
        ...
        CommonLayoutUtility.setWidthPrecent(this, 14); /// fills to: 100
    }
