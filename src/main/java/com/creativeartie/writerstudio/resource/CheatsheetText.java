 ...
 * <ul>
 * <li>{@link InfoFieldType} through {@link CheatsheetLabel#getLabel(CheatsheetText)}</li>
 * <li>{@link DirectoryType} through {@link CheatsheetLabel#getLabel(CheatsheetText)}</li>
 * </ul>
 */
public enum CheatsheetText {
    ...
    private CheatsheetText(String postfix){
        keyPostfix = postfix;
    }
