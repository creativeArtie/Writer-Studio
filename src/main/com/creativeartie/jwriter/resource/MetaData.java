...
public enum MetaData {
    ...
    PHONE("MetaData.AuthorPhone"), COPYRIGHT("MetaData.CopyrightYear"),
    KEY_WORD("MetaData.TitleKeyWord"), PAGE("MetaData.WordPage"),
    BY("MetaData.ByWord"), AUTHOR("MetaData.AuthorName");
