...
public enum TextPhrasePatterns implements PatternEnum {
    ...
    TextPhrasePatterns(TextSpanPatterns pattern, boolean refers) {
        textPattern = pattern;
        withRefers = refers;
    }

    public enum LineTextPart implements PatternEnum {
        BOLD("\\*"), UNDERLINE("_"), ITALICS("`"), TODO(IdentityTodoPattern.getFullPattern()),
        REFER(IdentityReferencePattern.getFullPattern()), TEXT("");
