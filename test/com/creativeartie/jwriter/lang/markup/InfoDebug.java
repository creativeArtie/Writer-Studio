...
public class InfoDebug {
    ...
    public void dataText(){
        ...
        new BranchTest.ContentTest().setText("**a").setBegin(false)
            .setEnd(false).setCount(1).test(doc, 3, "*\\*a",  0, 0);
